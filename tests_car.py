...
class TestCar(unittest.TestCase):
    ...
    def test_car_set_fuel_consumption_less_than_or_equal_to_zero_raises(self):
        with self.assertRaises(Exception) as ex:
    ...
    def test_car_set_fuel_capacity_less_than_or_equal_to_zero_raises(self):
        with self.assertRaises(Exception) as ex:
    ...
    def test_car_set_fuel_amount_less_than_or_equal_to_zero_raises(self):
    ...
    def test_drive_not_enough_fuel(self):
        needed = (200 / 100) * self.car.fuel_consumption
        needed += 1
        with self.assertRaises(Exception) as ex:
    ...
    def test_drive(self):
        ...
        needed = (200 / 100) * self.car.fuel_consumption
        self.car.refuel(50)
        self.car.fuel_amount -= needed
        self.assertEqual(50 - needed, self.car.fuel_amount)
